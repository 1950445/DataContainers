...
void main()
{
	...
	cout << "Дерево выполнено за " << double(end - start) / CLOCKS_PER_SEC << " секунд\n";
	//tree.Clear();
	//tree.print();
	cout << endl;
	/////////////////////////////////////////////////////////////////////////////////////////////////
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////
	cout << "Средне-арифметическое элементов дерева: ";
	start = clock();
	double avg = tree.Avg();
	end = clock();
	...
	measure("Средне-арфмитическое элемнтов в дереве:", tree, &Tree::Avg);
